...
<link id="style_color" href="${BASEPATH}assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li>
						<a href="javascript:;">
							...
							<span class="title">前台开发</span>
							<span class="arrow "></span>
						</a>
						<ul class="sub-menu">
							<li>
								<a href="javascript:;">
									<i class="icon-settings"></i> 布局 <span class="arrow"></span>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="#">Freemarker模版</a>
									</li>
									<li>
										<a href="#">页面布局</a>
									</li>
							...
							<li>
								<a href="javascript:;">
								<i class="icon-globe"></i> UI 使用 <span class="arrow"></span>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="#"><i class="icon-tag"></i> 通用</a>
									</li>
									<li>
										<a href="#"><i class="icon-pencil"></i> Button & Icons</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 版面设计</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 弹出窗口</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> Tab,Accordions & 导航栏</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 日期组件</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> Data Tables</a>
									</li>
									
									<li>
										<a href="#"><i class="icon-graph"></i> 树形控件</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 嵌入式列表</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 滑动控件</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 图表控件</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> Portlet</a>
									</li>
									<li>
										<a href="#"><i class="icon-graph"></i> 富文本控件</a>
									</li>
							...
							<li>
								<a href="javascript:;">
									<i class="icon-settings"></i> 页面示例 <span class="arrow"></span>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="#">Portfolio</a>
