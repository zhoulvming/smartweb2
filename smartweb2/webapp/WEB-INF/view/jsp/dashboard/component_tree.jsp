...
<div class="row">
	<div class="col-md-10">
		<div class="portlet light">
			...
			<div class="portlet-body">
				...
				<!-- BEGIN Default TREE  -->
				<div id="intro1" class="portlet box blue-hoki">
					<div class="portlet-title">
						<div class="caption">
	...
	<div class="col-md-2">
		<div class="page-nav">
			<ul id="nav">
				<li class="current"><a href="#intro1" >缺省样式</a></li>
				<li><a href="#intro2">Checkable</a></li>
				<li><a href="#intro3">右键菜单</a></li>
				<li><a href="#intro4">拖动</a></li>
			</ul>
		</div>
	</div>
