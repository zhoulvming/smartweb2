/**
Project script to handle the theme demo
**/
var Project = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Smartweb.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (Smartweb.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Smartweb.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Smartweb.getGlobalCssPath() + file + ".css");
